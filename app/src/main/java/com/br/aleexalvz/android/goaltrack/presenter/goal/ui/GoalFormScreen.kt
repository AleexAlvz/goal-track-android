...
fun GoalFormContent(
    ...
    onUIAction: (CreateGoalAction) -> Unit,
    onBackClicked: () -> Unit
) {
    Box(
        ...
        Button(
            ...
            onClick = { onUIAction(CreateGoalAction.Submit) }
        ) {
            Text(
    ...
    Column(
        ...
        DefaultOutlinedTextField(
            ...
            text = createGoalState.title,
            labelText = "Título da meta",
            onValueChange = { onUIAction(CreateGoalAction.UpdateTitle(it)) },
            errorMessage = createGoalState.titleError
        )
        ...
        DefaultOutlinedTextField(
            modifier = Modifier
                .fillMaxWidth()
                .padding(start = 16.dp, end = 16.dp, top = 16.dp),
            text = createGoalState.description,
            labelText = "Descrição",
            onValueChange = { onUIAction(CreateGoalAction.UpdateDescription(it)) },
            errorMessage = createGoalState.descriptionError
        )
        ...
        TextFieldWithDropDown(
            ...
            text = createGoalState.category?.name.orEmpty(),
            errorMessage = createGoalState.categoryError,
            labelText = "Categoria",
            onSelectedItem = { onUIAction(CreateGoalAction.UpdateCategory(it.toGoalCategoryEnum())) }
        )
    }
