...
import com.br.aleexalvz.android.goaltrack.login.presentation.viewmodel.SignUpViewModel
...
fun SignUpScreen(
    ...
    val loginUIState: SignUpUIState by signupViewModel.signupState.collectAsStateWithLifecycle()
    ...
    Column(
        ...
        PasswordOutlinedTextField(
            modifier = Modifier
                .fillMaxWidth()
                .padding(top = 24.dp),
            text = signupUiState.confirmPassword,
